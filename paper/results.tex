...
One of the most important outputs is the productivity of a cycle expressed as EggsProduced/#Chickens:

\begin{center}
    \begin{tabular}{| c | c | c | c |} 
        \hline
        Cycle & Organic & Productivity \\ [0.5ex] 
        \hline
        A & $\checkmark$ & 481.04 \\ [0.5ex] 
        \hline
        B & $\checkmark$ & 436.90 \\ [0.5ex] 
        \hline
        Z & $\checkmark$ & 420.63 \\ [0.5ex] 
        \hline
        X1 & $\times$ & 366.77 \\ [0.5ex] 
        \hline
        X2 & $\times$ & 316.29 \\ [0.5ex] 
        \hline
        Y & $\times$ & 292.25 \\ [0.5ex] 
        \hline
    \end{tabular}
